<%-- 
    Document   : login
    Created on : Nov 24, 2019, 8:33:21 AM
    Author     : ADMin
--%>
...
<form><div class="UserModalstyle__FormItem-uq4a18-6 llEucX" id="b"><span><label for="email" style="margin-right:6px">Email / SĐT</label><input type="text" id="email" name="email" placeholder="Nhập Email hoặc Số điện thoại" class="Input-sc-1sflv1m-0 coLFjn" ></div>
...
<button type="button" class="UserModalstyle__RightButton-uq4a18-8 isCvUd">
<span class="UserModalstyle__ButtonIcon-uq4a18-7 erimbq">
<i class="tikicon icon-facebook-white"></i>
</span>Đăng nhập bằng Facebook</button>
<button type="button" class="UserModalstyle__RightButton-uq4a18-8 bjWqhT">
<span class="UserModalstyle__ButtonIcon-uq4a18-7 erimbq">
<i class="tikicon icon-google-white"></i>
</span>Đăng nhập bằng Google</button>
<button type="button" class="UserModalstyle__RightButton-uq4a18-8 gdPUjQ">
<span class="UserModalstyle__ButtonIcon-uq4a18-7 erimbq">
<i class="tikicon icon-zalo"></i>
</span>Đăng nhập bằng Zalo</button>
</div>
</form>
</div>
</div>
